...
const pkgdef :Spk.PackageDefinition = (
  ...
  id = "e5zdjtjvf9msgyt3x60v7pdpx250kt6jevgnr8uurntj8y56055h",
  ...
  manifest = (
    ...
    appTitle = (defaultText = "Phabricator"),
    ...
    metadata = (
      ...
      icons = (
        appGrid = (png = (dpi1x = embed "img/Phab_logo.png")),
        grain = (png = (dpi1x = embed "img/Phab_logo.png")),
        market = (png = (dpi1x = embed "img/Phab_logo.png")),
        marketBig = (png = (dpi1x = embed "img/Phab_logo.png")),
      ),

      website = "http://phabricator.com",
      # This should be the app's main website url.

      codeUrl = "https://github.com/liamzdenek/phabricator-sandstorm",
      ...
      author = (
        ...
        contactEmail = "liamzdenek@gmail.com",
      ...
      shortDescription = (defaultText = "Development Platform"),
  ...
  #      ),
         (
           ...
           description = (defaultText = "full permissions"),
         ),
      ],
      roles = [
  ...
  #      ),
         (
           title = (defaultText = "default"),
           permissions = [false],
           verbPhrase = (defaultText = "can access Phabricator"),
           description = (defaultText = "Can open Phabricator and make changes."), 
         ),
         (
           title = (defaultText = "admin"),
           permissions = [true],
           verbPhrase = (defaultText = "can administrate Phabricator"),
           description = (defaultText = "Can open Phabricator with full administrative privileges"), 
         ),
  #      (
